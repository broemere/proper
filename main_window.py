...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # self.pipeline.register_observer("raw", self._update_raw_plot)
        # self.pipeline.register_observer("zeroed", self._update_transformed_plot)
        # self.pipeline.register_observer('bcimage', self._update_leveled_image)
        # self.pipeline.register_observer('thimage', self._update_threshed_image)
    ...
    def init_tabs(self, parent_layout: QVBoxLayout):
        ...
        # self.init_plot_tab()
        # self.init_frames_tab()
        # self.init_scale()
        # self.init_levels_tab()
        # self.init_thresh_tab()
        # self.init_first_canvas()
        # self.init_canvas()
    ...
    def on_csv_file_selected(self, path: str):
        ...
        # It's okay to do simple things like save settings here.
        #self.settings.setValue("last_dir", str(Path(path).parent))

        # Now, delegate the hard work to the pipeline.
        # This can be a direct call if it's fast, or queued if it's slow.
    ...
    def show_error_dialog(self, err_tb):
        ...
        msg_box.setInformativeText(
            "Please check the 'prim_explorer.log' file for detailed technical information."
        )
